...
package dev.gumil.acorn.compose.uistate
...
import dev.gumil.acorn.compose.ComposeContainer
import dev.gumil.acorn.compose.ComposeControllerFactory
import dev.gumil.acorn.compose.internal.v
import dev.gumil.acorn.compose.internal.w
import dev.gumil.acorn.compose.uistate.internal.Destination
...
sealed class UIState {
    ...
    fun withScene(
        ...
        viewControllerFactory: ComposeControllerFactory,
        data: TransitionData?
    ): UIState {
...
internal class NotVisibleWithDestination(
    ...
    private val existingViewController: ComposeContainer?
) : UIState() {
...
internal class VisibleWithDestination(
    ...
    override fun uiNotVisible(): UIState {
        ...
        val pendingDestination = scheduledDestination
